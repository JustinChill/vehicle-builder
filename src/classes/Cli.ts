...
// Define the Cli class to handle all Command Line interfaces
class Cli {
  // Vehicles property accepts Car and Truck and Motorbike objects by using the  union | operator
  ...
  // Inquirer prompt to create a vehicle
  createVehicle(): void {
    inquirer
      .prompt([
        {
      ...
      .then((answers) => {
        switch (answers.vehicleType) {
          ...
          case "Motorbike":
            ...
            break;
          default:
            console.log("Unknown vehicle type selected. Please try again.");
            break;
        }
      });
  }
  ...
  createCar(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // push the new car to the vehicles array
    ...
    inquirer
      .prompt([
        ...
        },
        {
          ...
          message: "Enter Front Wheel Diameter (in)",
        },
        {
          type: "input",
        ...
        },
        {
          ...
          message: "Enter Rear Wheel Diameter (in)",
        },
        {
          type: "input",
          name: "rearWheelBrand",
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              ...
              if (this.vehicles[i] instanceof Motorbike) {
                ...
                console.log("Nice try, but only a motorbike can do a wheelie!");
              }
            }
          }
      ...
      .prompt([
        {
          ...
          name: "CreateOrSelect",
          message:
            "Would you like to create a new vehicle or drive an existing vehicle?",
